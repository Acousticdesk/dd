...
import { getIsMobileSidebarShown, mobileSidebarToggle as mobileSidebarToggleImport } from '../../redux/ui/mobileSidebar';
...
const Header = ({
  ...
  return (
    <header className={`l-header ${isDarkTheme ? 'l-header--dark' : ''}`}>
      <button type="button" onClick={mobileSidebarToggle} className="l-header__logo-container text-center">
...
const mapDispatchToProps = dispatch => ({
  mobileSidebarToggle: bindActionCreators(mobileSidebarToggleImport, dispatch),
});
